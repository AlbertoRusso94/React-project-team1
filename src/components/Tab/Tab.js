                ...
                <div className="text-left">
                  ...
                  <div className="contentContainer">
                    ...
                    <h3>
                      ...
                      makes large profits in minutes a day. We are ex-quants
                      with combined 37 years of experience. Optionsfy software
                      picks the ticker, strikes and expiration dates for you so
                      you can profit without the long guesswork. It's powered by
                      an algorithm fed with 10 years of data and 10 factors
                      proven to work. Optionsfy saves you time and makes you
                      more profitable with high return, consistent trades in
                      minutes in ALL MARKET ENVIRONMENTS.
                    </h3>
                  </div>
                </div>
              </TabPane>
                ...
                <div className="text-left">
                  ...
                  <div className="contentContainer">
                    <h3>
                      ...
                      buy? We scan the entire options chain so you don’t have
                      to, researching each possible trade ahead of time and
                      recommend you the best plays
                    </h3>
                    <lord-icon
                ...
                <div className="text-left">
                  ...
                  <div className="contentContainer">
                    ...
                    <h3>
                      ...
                      use starting on day 1 and give you the competitive
                      knowledge learned from years of trial & error.
                    </h3>
                  </div>
                </div>
              </TabPane>
